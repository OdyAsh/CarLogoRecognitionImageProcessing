%ASKs DR about needing to output logo name or only subimage: both + subimage from
...
for i = 5 : 5    %length(imgs)
    ...
    imgsFiltered{i} = imbinarize(nlfilter(imgsMedian{i}, [21 21], func)); %DIFF
...
function imgsLogos = getImgsLogos()
    ...
    imgsLogos{11} = imread("logos\11.Hyundai.png");
...
function imgsLogosGrayed = getImgsLogosGrayed()
    ...
    imgsLogosGrayed{11} = rgb2gray(imread("logos\11.Hyundai.png"));
